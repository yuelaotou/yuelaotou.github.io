...
Class UpLoadClass
	...
	Private Sub Class_Initialize
		...
		m_Charset  = "utf-8"
		m_TotalSize= 0
		m_MaxSize  = 10485760 '默认为10mb
		m_FileType = "jpg/gif/jpeg/png/bmp"
		m_SavePath = "../../"&king_upath&"/"
		m_AutoSave = 2
		Dim dtmNow : dtmNow = Date()
		m_strDate  = Year(dtmNow)&Right("0"&Month(dtmNow),2)&Right("0"&Day(dtmNow),2)
		m_lngTime  = Clng(Timer()*1000)
		Set m_binForm = Server.CreateObject(king_stm)
		Set m_binItem = Server.CreateObject(king_stm)
