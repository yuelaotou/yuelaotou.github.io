...
<div id="container">
  ...
  <div id="menu">
    <ul>
      ...
      <li><a href="team.htm" class="selected">设计团队</a></li>
...
$teamType$
    ...
    <div class="teamList">
      <div class="teamList_title">您当前的位置：<a href="index.htm">首页</a> &gt;&gt; 设计团队</div>
      <ul class="teamList_content">
$teamlist$
      </ul>

      <div id="picpage">
        <div class="picpage_title">个人风采 - 个人作品</div>
			$teamEmbed$
        <!--<embed src="http://cf3.123show.com/publish/launch/flash/render.swf?cid=17750&pid=48772" quality="high" width="555" height="490" align="middle" allowScriptAccess="always" type="application/x-shockwave-flash"></embed>-->
      </div>
    </div>
  </div>
  <div class="blank9"></div>
