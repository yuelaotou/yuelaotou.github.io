...
<div id="container">
  ...
  <div id="menu">
    <ul>
      ...
      <li><a href="site.htm" class="selected">施工现场</a></li>
      <!--<li><a href="team.htm">设计团队</a></li>-->
...
$siteType$
    ...
    <div class="teamList">
      <div class="teamList_title">您当前的位置：<a href="index.htm">首页</a> &gt;&gt; 施工现场</div>
      <ul class="teamList_content">
$sitelist$
      </ul>

      <div id="picpage">
        <div class="picpage_title">施工现场 - 图集</div>
			$siteEmbed$
      </div>
    </div>
  </div>
