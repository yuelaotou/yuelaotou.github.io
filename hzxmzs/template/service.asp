...
<div id="container">
  ...
  <div id="menu">
    <ul>
      ...
      <li><a href="service.htm" class="selected">客户服务</a></li>
...
$pagination$
          ...
          <ul class="list_word">
			<li><span style="color:red">点击次数</span><span style="color:red">发布日期</span><span style="color:red;float:left">标题内容</span></li>
$service$
          </ul>
        </div>
      </div>
