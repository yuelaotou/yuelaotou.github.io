...
<div id="container">
  ...
  <div id="menu">
    <ul>
      ...
      <li><a href="knowledge.htm" class="selected">装修知识</a></li>
...
$pagination$
          ...
          <ul class="list_word">
			<li><span style="color:red">点击次数</span><span style="color:red">发布日期</span><span style="color:red">发布人</span><span style="color:red;float:left">标题内容</span></li>
$knowledgelist$
          </ul>
        </div>
      </div>
