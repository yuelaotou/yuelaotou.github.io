...
<div id="container">
  ...
  <div id="menu">
    <ul>
      ...
      <li style="margin-right:0px;"><a href="contact.htm" class="selected">联系我们</a></li>
    </ul>
  </div>
  <div class="blank4"></div>
  <div id="contenttop">
    ...
    <div id="colAbout">
      <div class="colAbout colHeight429 font14">
        <div class="titleBar ui_tit26">
          <div style="text-align:center;font-weight:bold;">地理位置</div>
        </div>
		  <img src="UploadFile/map.jpg" border="0" />
      </div>
    </div>
  </div>
  <div class="blank9"></div>
