...
If Trim(Request.QueryString("Action"))="Lock" Then
	...
	Call Lock_OK("Page",ID,ReCord,Flag,"?SS_ID="&SS_ID&"")
End if 
...
IF Key = Empty Then
	Sql="select * from Page Where SS_ID="&SS_ID&" order by Rank asc,ID desc"
Else
	Sql="select * from Page Where SS_ID="&SS_ID&" And Title like '%"&key&"%' order by Rank asc,ID desc"
End IF
...
%></font></strong>
          ...
          <td width="100" align="center"><img src="../sysImages/Search.gif" width="20" height="20" border="0" align="absmiddle">搜索单页</td>
          <td>
...
For I=1 to rs.pagesize
 ...
 %>
        <tr bgcolor="#FFFFFF" style="cursor:hand" OnMouseOver="this.bgColor='#F0F0F0'" OnMouseOut="this.bgColor='#FFFFFF'"> 
          ...
          <td align="center">[NO:<%= RS("Rank") %>]</td>
          <td align="center"> <a href="Page_Edit.asp?SS_ID=<%= SS_ID %>&ID=<%= rs("ID") %>"><img src="../sysImages/Edit.gif" width="12" height="12" border="0" alt="修改"></a>          </td>
...
<% Call RS_Empty()	'没有记录 %>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td align="center"> 
			<input type="button" name="Submit_OK" value="添加(A)" accesskey="a" onClick="location='Page_Insert.asp?SS_ID=<%= SS_ID %>'">
