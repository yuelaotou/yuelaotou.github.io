    ...
    <tr>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#D7DEF8">
        <tr bgcolor="#FFFFFF"> 
          ...
          <td width="70" align="center" bgcolor="#FFFFFF">应聘时间</td>
...
For I=1 to rs.pagesize
 ...
 %>
        <tr bgcolor="#FFFFFF" style="cursor:hand" OnMouseOver="this.bgColor='#F0F0F0'" OnMouseOut="this.bgColor='#FFFFFF'"> 
          ...
          <td align="center"> <img src="../sysImages/del.gif" width="16" height="16" border="0" onClick="{if(confirm('确定删除吗?')){location='?Action=Del&id=<%= rs("id") %>&jobid=<%= jobid %>';return true;}return false;}">          </td>
        </tr>
        <% 
rs.MoveNext
NEXT
