...
If Trim(Request.Form("Action"))="Insert" Then
	...
	Rs.Update
	'Sql = "insert into Product(SS_ID,Title,Img,Stype,kehu,URL,Content) Values("&SS_ID&",'"&Title&"','"&Img&"','"&Stype&"','"&kehu&"','"&URL&"','"&Content&"')"
...
%>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#D7DEF8">
          <tr>
            ...
            <td bgcolor="#FFFFFF"><input name="Product_Name" type="text" id="Product_Name" size="30" />
              &nbsp;&nbsp; </td>
