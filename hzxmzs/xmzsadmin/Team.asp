...
If Trim(Request.QueryString("Action"))="Lock" Then
	...
	Call Lock_OK("Team",ID,ReCord,Locks,"?SS_ID="&SS_ID&"")
End if 
...
For I=1 to rs.pagesize
 ...
 %>
        <tr bgcolor="#FFFFFF" style="cursor:hand" OnMouseOver="this.bgColor='#F0F0F0'" OnMouseOut="this.bgColor='#FFFFFF'">
          ...
          <td align="center"><a href="Team_Edit.asp?SS_ID=<%= SS_ID %>&ID=<%= rs("ID") %>"><img src="../sysImages/Edit.gif" width="12" height="12" border="0" alt="修改"></a> </td>
...
%>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td align="center"><input type="button" name="Submit_OK" value="添加" onClick="location='Team_Insert.asp?SS_ID=<%= SS_ID %>'">
            &nbsp;
