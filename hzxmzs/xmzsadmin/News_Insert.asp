...
If Trim(Request.Form("Action"))="Insert" Then
	...
	RS.close
	Set RS = nothing
	Response.Write "<script>alert('增加成功!');location='News.asp?SS_ID="&SS_ID&"';</script>"
	Response.end
End If
%>
<html>
  ...
  <form name="theForm" method="post" action="" onSubmit="return input_ok(this)">
    <tr>
      <td><fieldset style="padding: 5" class="body">
        <legend><strong>新闻频道┠</strong><font color="#FF0000">
          <% 
...
%>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#D7DEF8">
          <tr>
            ...
            <td bgcolor="#FFFFFF"><input name="ImgLock" type="checkbox" id="ImgLock" value="1" title="提示:图片链接时在首页显示图片新闻">
              图片链接
              <input name="Counts" type="text" id="Counts" value="0" size="4" maxlength="4">
              点击</td>
            <td width="150" rowspan="4" align="center" valign="middle" bgcolor="#FFFFFF"><img src="../sysImages/NoImage.gif" name="logo" width="120" height="120" border="1" id="logo" onClick="newimg(this.src);" style="CURSOR: hand" title="提示:查看图片实际大小"> </td>
          </tr>
          <tr>
            <td height="22" align="center" bgcolor="#FFFFFF">链接图片：</td>
            <td bgcolor="#FFFFFF"><input name="NewsImage" type="text" id="Img" size="20" readonly="0" title="提示:请选择上传">
          ...
          <tr>
			...
			<input name="Title" type="text" id="Title" size="50">
			 ...
			 <input type="button" name="Color" value="颜色" onClick="openwin('../Include/color.htm',300,260)" title="">
		    </td>
          </tr>
          <tr>
			...
			RC.open sql,conn,1,1
			 ...
			 %>
			  ...
			  set Rc=Nothing
			   %>
              来源：
              <input name="NewsSource" type="text" id="NewsSource" value="" size="10">
          ...
          <tr>
            ...
            <td colspan="2" bgcolor="#FFFFFF"><textarea name="Content" style="display:none"></textarea>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="30" align="center"><input type="submit" name="Submit_OK" value="增加(A)" accesskey="a">
              &nbsp;
              ...
              <input name="SS_Path" type="hidden" id="SS_Path" value="<%= SS_Path %>">
            </td>
          </tr>
        </table>
      </fieldset></td>
